...
public class J05062 {
    ...
    private static class SinhVien implements Comparable<SinhVien> {
        ...
        public SinhVien(String name, double scoreTBC, int scoreRL) {
            ...
            if (this.scoreTBC >= 3.6 && this.scoreRL >= 90) {
                this.hocBong = "XUATSAC";
            } else if (this.scoreTBC >= 3.2 && this.scoreRL >= 80) {
                this.hocBong = "GIOI";
            } else if (this.scoreTBC >= 2.5 && this.scoreRL >= 70) {
                this.hocBong = "KHA";
            } else {
                this.hocBong = "KHONG";
            }
        ...
        public int compareTo(SinhVien o) {
            if (this.hocBong.contains("KHONG") && !o.hocBong.contains("KHONG")) {
                return 1;
            }
            if (!this.hocBong.contains("KHONG") && o.hocBong.contains("KHONG")) {
                return -1;
            }
            if (this.scoreTBC < o.scoreTBC) {
                return 1;
            }
            return -1;
        }
