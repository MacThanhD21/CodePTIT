...
class Billll {
    ...
    public Billll(int id_Bill, String id_Cus, String id_Item, int quantity, ArrayList<Customer> customers, ArrayList<Item> items) {
...
public class J07020 {
    public static void main(String[] args) throws FileNotFoundException{
        ...
        ArrayList <Billll> Bill_List = new ArrayList<>();
        ...
        for(int i = 0; i < n; i++) {
            ...
            Bill_List.add(new Billll(i + 1, id_Cus, id_Item, quantity, Cus_List, Item_List));
        }
        
        for(Billll x : Bill_List) {
