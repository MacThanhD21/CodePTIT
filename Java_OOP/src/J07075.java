...
class Subjectt {
    ...
    public Subjectt(String id, String name, String credits) {
        this.id = id;
        this.name = name;
...
class SessionClasss implements Comparable<SessionClasss>{
    private String id_Group, id_Sub, TeachingDates, Study_Crew, name_Pro, id_Room;
    private Subjectt sub;

    public SessionClasss(int id_Group, String id_Sub, String TeachingDates, String Study_Crew, String name_Pro, String id_Room, ArrayList<Subjectt> dsSub) {
    ...
    @Override
    public int compareTo(SessionClasss o) {
...
public class J07075 {
    public static void main(String[] args) throws FileNotFoundException{
        ...
        ArrayList <Subjectt> dsSub = new ArrayList<>();

        while(n-->0) {
            dsSub.add(new Subjectt(sc.nextLine(), sc.nextLine(), sc.nextLine()));
        }
        // for(Subject x : dsSub) {
        ...
        ArrayList <SessionClasss> dsPro = new ArrayList<>();
        for(int i = 0; i < n; i++) {
            dsPro.add(new SessionClasss(i + 1, sc.nextLine(), sc.nextLine(), sc.nextLine(), sc.nextLine(), sc.nextLine(), dsSub));
        }
