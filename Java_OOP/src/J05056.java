...
class Athletee implements Comparable<Athletee> {
    private String id, name, DOB, st_time, en_time;

    public Athletee(int id, String name, String DOB, String st_time, String en_time) {
    ...
    @Override
    public int compareTo(Athletee o) {
...
public class J05056 {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<Athletee> arr = new ArrayList<>();

        for (int i = 0; i < n; i++) {
            arr.add(new Athletee(i + 1, sc.nextLine(), sc.nextLine(), sc.nextLine(), sc.nextLine()));
        }
        // Tạo một danh sách mới và sao chép nội dung từ danh sách ban đầu
        ArrayList<Athletee> newArr = new ArrayList<>(arr);
        ...
        Collections.sort(arr, new Comparator<Athletee>() {

            @Override
            public int compare(Athletee o1, Athletee o2) {
