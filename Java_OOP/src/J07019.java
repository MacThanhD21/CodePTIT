...
class Billl {
    ...
    public Billl(String id, int quantity, ArrayList<Product> products) {
        this.id = id;
    ...
    public String toString() {
        ...
        return new_Id
                ...
                + " " + this.getDiscount()
                + " " + (this.getTotalBill() - this.getDiscount());
    }
}
...
public class J07019 {
    public static void main(String[] args) throws FileNotFoundException{
        ...
        ArrayList <Billl> arr2 = new ArrayList<>();

        for(int i = 0; i < n; i++) {
            arr2.add(new Billl(sc.next(), Integer.parseInt(sc.nextLine().substring(1)), arr1));
        }
