...
class SessionClass implements Comparable<SessionClass>{
    ...
    public int compareTo(SessionClass o) {
        if (!this.TeachingDates.equals(o.TeachingDates)) {
            return this.TeachingDates.compareTo(o.TeachingDates);
        } else if (!this.Study_Crew.equals(o.Study_Crew)) {
...
public class J07074 {
    public static void main(String[] args) throws FileNotFoundException{
        ...
        for(SessionClass x : dsPro) {
            if(x.getIdSub().equals(id_Sub)) {
                System.out.println("LICH GIANG DAY MON " + x.getNameSub() + ":");
                break;
            }
        }
