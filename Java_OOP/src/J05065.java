...
class NhanVienn {
    ...
    public NhanVienn(String id, String name) {
        this.id = id;
        this.name = name;
    }
...
public class J05065 {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<NhanVienn> arr = new ArrayList<>();

        int cnt_GD = 0, cnt_TP = 0, cnt_PP = 0;

        for(int i = 0; i < n; i++) {
            NhanVienn x = new NhanVienn(sc.next(), sc.nextLine());
        ...
        Collections.sort(arr, new Comparator<NhanVienn>() {

            @Override
            public int compare(NhanVienn o1, NhanVienn o2) {
