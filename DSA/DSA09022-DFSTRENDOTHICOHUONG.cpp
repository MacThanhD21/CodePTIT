...
Input:
   ...
   |V|, |E|, uÎV tương ứng với số đỉnh, số cạnh và đỉnh 
   
   bắt đầu duyệt; Dòng tiếp theo đưa vào các bộ đôi uÎV, vÎV 
...
Output:
   ...
   Đưa ra danh sách các đỉnh được duyệt theo thuật toán DFS(u) 
