...
/*
    ...
    Cho đồ thị vô hướng G=(V, E). Hãy xây dựng một cây khung của 
    
    đồ thị G với đỉnh u ∈ V là gốc của cây bằng thuật toán DFS.
...
Output
    ...
    thứ tự duyệt của thuật toán DFS. Ngược lại nếu không 
