...
/*
	...
	chỉ bao gồm các số 0, 1, 2. Hãy sắp xếp mảng A[] theo thứ tự tăng dần. 
	
	Ví dụ với A[] = {0, 2, 1, 2, 0} ta kết quả A[] = {0, 0, 1, 2, 2}.
...
Input:
	...
	là số phần tử của mảng A[]; dòng tiếp theo là n số 
